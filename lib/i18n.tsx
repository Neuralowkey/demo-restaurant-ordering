...
export const STRINGS = {
  he: {
    ...
    nav_storefront: "החנות",
    demo_badge: "הדגמה",
    demo_blurb: "בנייה לתיק עבודות. כל מנה, מחיר, לקוח והזמנה הומצאו.",
    lang_label: "EN",
  ...
  en: {
    ...
    demo_badge: "DEMO",
    demo_blurb: "A portfolio build. Every dish, price, customer and order is invented.",
    lang_label: "עב",
